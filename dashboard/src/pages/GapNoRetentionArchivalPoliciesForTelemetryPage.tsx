...
// Gap (Non-AI): No retention/archival policies for telemetry
// No retention/archival policies for telemetry
import React, { useState } from 'react';

export default function GapNoRetentionArchivalPoliciesForTelemetryPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-retention-archival-policies-for-telemetry/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No retention/archival policies for telemetry</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No retention/archival policies for telemetry</p>
