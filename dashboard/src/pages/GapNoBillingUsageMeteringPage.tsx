...
// Gap (Non-AI): No billing/usage metering
// No billing/usage metering
import React, { useState } from 'react';

export default function GapNoBillingUsageMeteringPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-billing-usage-metering/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No billing/usage metering</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No billing/usage metering</p>
